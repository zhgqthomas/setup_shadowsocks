...
经过比较之后，选择了 [Vultr](http://www.vultr.com/?ref=7138265) 这个 VPS 提供商。原因是 [Vultr](http://www.vultr.com/?ref=7138265) 提供基于 KVM 虚拟的 VPS，可以支持 Docker 和 TCP-BBR 技术，并且其现在有每个月只需 `2.5 美元`的选择，对于搭建梯子和个人博客搭建等日常学习来说已经绰绰有余了。

### 充值
注册了 [Vultr](http://www.vultr.com/?ref=7138265) 帐号后，必须先充值才可以进行 VPS 的选择，现在优惠活动是充值 5 美元赠送 5 美元。像之前赠送 20 美元的活动已经取消了。
